      ...
      <div className="w-full flex flex-col justify-center items-center">
        <div className="w-4/6 flex flex-col justify-center items-center">
          ...
          <div className="flex justify-between mt-8">
            <div className="bg-blue-200 rounded-lg p-6 text-center w-2/3 mx-4">
              ...
              <p className="text-xs mb-2">
                Excelente trabajo en la creación de nuestra landing en
                WordPress. ¡Gracias por tu esfuerzo!
              </p>
            ...
            <div className="bg-blue-200 rounded-lg p-6 text-center w-2/3 mx-4">
              ...
              <p className="text-xs mb-2">
                Estamos muy contentos con la landing que desarrollaste desde
                cero. El código es limpio y eficiente.
              </p>
            ...
            <div className="bg-blue-200 rounded-lg p-6 text-center w-2/3 mx-4">
              ...
              <p className="text-xs mb-2">
                ...
                materializar nuestras ideas en código fue realmente
                impresionante. Gracias por tu profesionalismo y dedicación.
              </p>
