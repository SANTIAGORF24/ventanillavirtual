    ...
    <div className="mt-20 w-full flex flex-col justify-center items-center px-4">
      <div className="w-5/6 flex flex-col justify-center items-center">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center w-full py-10 space-y-10 md:space-y-0 md:space-x-10">
          <div className="w-full md:w-1/3 p-6 md:p-8 border border-blue-500 rounded-lg mb-8 md:mb-0">
            <h3 className="text-xl md:text-3xl font-bold mb-4">
              Landing en WordPress
            </h3>
            <p className="text-gray-500 text-lg md:text-xl mb-4">$400 USD</p>
            <p className="mb-4">
          ...
          <div className="w-full md:w-1/3 p-6 md:p-8 border border-blue-500 rounded-lg mb-8 md:mb-0">
            ...
            <p className="text-gray-500 text-lg md:text-xl mb-4">Cotizar</p>
            <p className="mb-4">
