    ...
    <div className="w-4/5 mx-auto space-y-8 p-4 border border-gray-300 rounded mb-20">
      <div className="space-y-4">
        ...
        >
          ...
          <option value="certificacion-contrato">
            Certificación de contrato
          </option>
          <option value="certificacion-ingresos-retenciones">
            Certificación de ingresos y retenciones (contratistas y personas
            jurídicas)
          </option>
          <option value="certificado-relacion-pagos">
            Certificado de relación de pagos (Contratistas y personas jurídicas)
          </option>
          <option value="certificacion-salarios">
            Certificación de Salarios (Para solicitud de pensión o de bono
            pensional)
          </option>
          <option value="certificacion-laboral">
            Certificación Laboral (Ex funcionarios)
          </option>
          <option value="otras-certificaciones">Otras certificaciones</option>
        </select>
      </div>
      <div className="space-y-4">
