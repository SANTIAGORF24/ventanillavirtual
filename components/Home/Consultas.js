    ...
    <div className="w-4/5 mx-auto space-y-8 p-4 border border-gray-300 rounded mb-20">
      <div className="space-y-4">
        ...
        >
          ...
          <option value="certificado-atleta-excelencia">
            Certificado de Atleta Excelencia y Glorias del Deporte
          </option>
          <option value="certificado-existencia-representacion-legal">
            Certificado de Existencia y Representación Legal de Federaciones
            Deportivas y Clubes Profesionales organizados como Corporaciones y
            Asociaciones
          </option>
        </select>
      </div>
