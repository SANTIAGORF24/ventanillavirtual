          ...
          <div className="flex flex-col lg:flex-row items-center py-8">
            <div className="mb-8 lg:mb-0 lg:w-1/3">
              <CardComponent
                ...
                footer={<a href="#">Puedes contactarnos</a>}
              />
            </div>
            <div className="mb-8 lg:mb-0 lg:w-1/3">
              <Accordion variant="splitted">
                ...
                >
                  <p>
                    ...
                    impulsan el progreso. En Sibartech, no solo construimos
                    líneas de código, construimos puentes digitales entre
                    conceptos y ejecución. Nos especializamos en el desarrollo
                    de proyectos a medida que abarcan desde aplicaciones web y
                    móviles hasta sistemas complejos de gestión. Cada proyecto
                    es una oportunidad para demostrar nuestra destreza técnica y
                    creativa.
                  </p>
                </AccordionItem>
                <AccordionItem
                ...
                >
                  <p>
                    En el mundo dinámico de la tecnología, la innovación es
                    clave. En Sibartech, abrazamos la filosofía de la mejora
                    continua. Mantenemos nuestros conocimientos actualizados con
                    las últimas tendencias y tecnologías para ofrecerte
                    soluciones vanguardistas que te posicionen a la vanguardia
                    de tu industria.
                  </p>
                </AccordionItem>
              </Accordion>
