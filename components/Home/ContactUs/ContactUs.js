...
const ContactUs = () => {
  return (
    <div className="px-2 sm:flex items-center flex-col justify-center max-w-full pb-10">
      ...
      <div className="w-4/5 sm:flex justify-between">
        <div className="w-1/3 flex items-center h-[350px] gap-6 max-sm:-my-10">
          <p className="text-4xl font-extrabold max-sm:text-3xl">
            Construimos para{" "}
        ...
        <form className="w-1/2 flex flex-col gap-4 max-sm:w-full">
