      ...
      <div className="space-y-4">
        ...
        >
          ...
          <option value="educacion-prevencion-antidopaje">
            Actividades de educación y prevención antidopaje
          </option>
          <option value="capacitacion-centro-ciencias-deporte">
            Capacitación o visita al Centro de Ciencias del Deporte
          </option>
          <option value="asesoria-infraestructura-deportiva">
            Asesoría en lineamientos técnicos para el desarrollo de
            infraestructura deportiva, recreativa y lúdica
          </option>
        </select>
      </div>
